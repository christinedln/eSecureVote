...
class Admin(User):
    ...
    def create_election(self, election: Election):
        ...
        self._db_service.save_election(election_data)
    ...
    def __retrieve_decrypted_ballots(self, election_id: str, encrypted_ballots: list):
        election = Election()
        election.get_decrypted_ballots(election_id, encrypted_ballots)


    def retrieve_decrypted_ballots(self, election_id: str, encrypted_ballots: list):
        self.__retrieve_decrypted_ballots(election_id, encrypted_ballots)
